...
import com.change_vision.safilia.api.inf.editor.TransactionAccessor;
...
public class RunCommand {
    ...
    public static void execute(ScriptViewContext context) {
        ...
        try {
            ...
            if (TransactionAccessor.isInTransaction()) {
                TransactionAccessor.abortTransaction();
            }
        }
    }
    ...
    public static void evalScript(String scriptKind, String scriptString, ScriptViewContext context) {
        ...
        try {
            projectAccessor = SafiliaAPI.getSafiliaAPI().getProjectAccessor();
