...
import safilia.plugin.script.command.BrowseCommand;
import safilia.plugin.script.command.ClearOutputCommand;
import safilia.plugin.script.command.CloseCommand;
import safilia.plugin.script.command.NewCommand;
import safilia.plugin.script.command.OpenCommand;
import safilia.plugin.script.command.ReloadCommand;
import safilia.plugin.script.command.RunCommand;
import safilia.plugin.script.command.SaveAsCommand;
import safilia.plugin.script.command.SaveCommand;
