...
import com.change_vision.safilia.api.inf.ui.IMessageProvider;

public class Messages implements IMessageProvider {

    public static final String DEFAULT_BUNDLE = "com.change_vision.safilia.plugin.script.messages";
